...
Feature: Registrar cuenta nueva de consumidor
  ...
  para poder contactar profesionales que resuelvan problemas en mi hogar
    ...
    Scenario: 01-RCN Registrar una cuenta nueva correctamente
        When me registro como usuario consumidor con correo "ana@example.com", nombre "Ana Perez" y contraseña "Segura12345?"
    ...
    Scenario: 02-RCN Rechazar un registro con correo sin @
        When me registro como usuario consumidor con correo "anaexample.com", nombre "Ana Perez" y contraseña "Segura12345?"
    ...
    Scenario: 03-RCN Rechazar un registro con correo sin dominio
        When me registro como usuario consumidor con correo "ana@", nombre "Ana Perez" y contraseña "Segura12345?"
        Then el sistema me indica que el formato del correo es inválido

    Scenario: 04-RCN Rechazar un registro con correo sin nombre de usuario
        When me registro como usuario consumidor con correo "@example.com", nombre "Ana Perez" y contraseña "Segura12345?"
        Then el sistema me indica que el formato del correo es inválido
    ...
    Scenario: 03-RCN Rechazar un registro con contraseña con menos de 12 caracteres
        When me registro como usuario consumidor con correo "ana@example.com", nombre "Ana Perez" y contraseña "abc123"
    ...
    Scenario: 04-RCN Rechazar un registro con contraseña sin mayúscula
        When me registro como usuario consumidor con correo "ana@example.com", nombre "Ana Perez" y contraseña "abc123456789!"
    ...
    Scenario: 06-RCN Rechazar un registro con contraseña sin número
        When me registro como usuario consumidor con correo "ana@example.com", nombre "Ana Perez" y contraseña "aaaaaaasdsadfsaf!"
        Then el sistema me indica que la contraseña es insegura
    ...
    Scenario: 05-RCN Rechazar un registro con correo ya existente
        ...
        When solicito registrar una cuenta de consumidor con correo "carla@example.com", nombre "Carla Gomez" y contraseña "Segura12345?"
