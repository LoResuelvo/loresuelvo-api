...
func (service *serviceMock) ListConsumers(ctx context.Context) ([]readmodel.Consumer, error) {
...
func (service *serviceMock) ListProviders(ctx context.Context) ([]readmodel.Provider, error) {
	args := service.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
